 ...
 */
export function isPuzzleComplete(currentArr, solutionArr) {
 ...
 * @returns 타일 클릭 처리 결과
 */
export function processTileClick(row, col, currentArr, gridSize) {
...
export function moveTilePure(puzzle, row, col, emptyRow, emptyCol) {
