...
export default function Button(options) {
    const { width = 200, height = 50, text, fontSize = 28, fillColor = COLORS.SECONDARY, textColor = COLORS.BLACK, borderColor = COLORS.BLACK, borderWidth = 3, borderRadius = 10, onClick, } = options;
