...
export class GameOverScene extends Scene {
    constructor(parent) {
        ...
        Object.defineProperty(this, "bestValue", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.scoreManager.on('highScoreChanged', this.updateScoreDisplay.bind(this));
    }
    initialize() {
        super.initialize();
        this.addGround();
    ...
    addGameOverUI() {
        ...
        divider.rect(boxX + boxWidth / 2 - dividerWidth / 2, boxY + (boxHeight - dividerHeight) / 2, dividerWidth, dividerHeight);
        divider.fill();
        ...
        this.scoreValue.position.set(boxX + boxWidth * 0.25, boxY + boxHeight * 0.6);
        ...
        this.addChild(box, divider, scoreLabel, this.scoreValue, bestLabel, this.bestValue);
    }
    addTitle() {
